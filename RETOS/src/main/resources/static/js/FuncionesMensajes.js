...
function autoInicioRelacionCliente() {
    ...
    $.ajax({
        url: "http://129.151.96.175:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
...
function autoInicioCostume() {
    ...
    $.ajax({
        url: "http://129.151.96.175:8080/api/Costume/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
...
function autoInicioMensajes() {
    ...
    $.ajax({
        url: "http://129.151.96.175:8080/api/Message/all",
        type: "GET",
        datatype: "JSON",
        success: function (respuesta) {
...
function consultarMessageid(idElemento) {
    ...
    $.ajax(
        {
            url: 'http://129.151.96.175:8080/api/Message/' + id,
            type: 'GET',
            dataType: 'json',
...
function pintarRespuestaMensajes(respuesta) {
    ...
    myTable += "<th scope='col'>ELIMINAR</th>";
    myTable += "</tr></thead>";
    if (respuesta.length < 1) {
        myTable += "<tbody><tr>";
        myTable += "<td scope='row'>" + "NO HAY ELEMENTOS PARA MOSTRAR" + "</td>";
    }
    else {
...
function guardarInformacionMensajes() {
   if (!MensajeC) {
        ...
        $.ajax({
            ...
            url: "http://129.151.96.175:8080/api/Message/save",
...
function actualizarInformacionMensaje() {
    if (!MensajeA) {
        ...
        $.ajax({
            url: "http://129.151.96.175:8080/api/Message/update",
            type: "PUT",
            data: dataToSend,
            contentType: "application/JSON",
            datatype: "JSON",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url: "http://129.151.96.175:8080/api/Message/" + idElemento,
